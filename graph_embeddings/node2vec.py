...
class Node2VecEmbedder():
    def __init__(self, path_to_edges, number_of_walks, walk_length, embedding_size, p, q, epochs, save_dir):
        """
        Args:
            path_to_edges:
            number_of_walks:
        ...
        self.q = q
        self.epochs = epochs
        self.save_path = os.path.join(save_dir, "node2vec_{}_{}_{}.model".format(self.p, self.q, self.embedding_size))
    ...
    def learn_n2v_embeddings(self, workers=0):
        ...
        g.read_edg(self.path_to_edges, weighted=False, directed=False)
