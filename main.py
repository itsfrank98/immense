...
def main(textual_content_link, technique="node2vec", social_net_url=None, spatial_net_url=None, rel_adj_mat_path=None, spat_adj_mat=None,
    ...
    dang_ae, safe_ae, w2v_model, tree_rel, tree_spat, mlp = train(
        ...
        p_rel=p_rel, q_spat=q_spat, q_rel=q_rel, n2v_epochs_spat=n2v_epochs_spat, n2v_epochs_rel=n2v_epochs_rel, rel_node_emb_technique=technique,
        spat_node_emb_technique=technique, adj_matrix_spat_path=spat_adj_mat, adj_matrix_rel_path=rel_adj_mat_path, id2idx_rel_path=id2idx_rel_path,
        id2idx_spat_path=id2idx_spat_path, rel_autoenc_epochs=rel_autoenc_epochs, spat_autoenc_epochs=spat_autoenc_epochs)

    test(test_df=test_df, train_df=train_df, w2v_model=w2v_model, dang_ae=dang_ae, safe_ae=safe_ae, tree_rel=tree_rel, tree_spat=tree_spat,
         mlp=mlp, spat_node_emb_technique=technique, rel_node_emb_technique=technique, id2idx_rel_path=id2idx_rel_path, id2idx_spat_path=id2idx_spat_path)
...
if __name__ == "__main__":
    main(textual_content_link="textual_content_link",
         ...
         p_rel=1, q_spat=4, q_rel=4, n2v_epochs_spat=100, n2v_epochs_rel=100, technique="autoencoder",
